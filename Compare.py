...
user_handle = "@durkeeturkey"
celebrity_handle = "@officialjaden"
...
sorted_result = sorted(user.items(), key=operator.itemgetter(1), reverse=True)

for keys, value in sorted_result[:20]:
    print keys,
    print(user[keys]),
